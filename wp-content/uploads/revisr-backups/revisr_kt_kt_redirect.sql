...
CREATE TABLE `kt_kt_redirect` (
  ...
  `rdct_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `rdct_title` varchar(255) DEFAULT NULL,
  `rdct_dest_link` varchar(255) DEFAULT NULL,
  `rdct_assign_posts` text,
