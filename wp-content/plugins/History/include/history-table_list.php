...
add_filter( 'manage_edit-history_post_columns', 'my_edit_history_post_columns' ) ;
function my_edit_history_post_columns( $columns ) {

	$columns = array(
		'cb' => '<input type="checkbox" />',
		'title' => __( 'History Post Title' ),
		'history_date' => __( 'History Date' ),
...
add_action( 'manage_history_post_posts_custom_column', 'my_manage_history_post_columns', 10, 2 );
function my_manage_history_post_columns($column_name, $post_ID) {
