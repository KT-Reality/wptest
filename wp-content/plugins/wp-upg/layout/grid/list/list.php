...
if($popup=="on")
			...
			<div id='my-content-<?php echo get_the_ID(); ?>' style='padding:10px; background:#fff;'>
						 <p>
  ...
  <div class="obox" >
	...
	<?php
		...
		else
		{
			...
			//echo '<a href="#my-content-'.get_the_ID().'" title="'.$thetitle.'" class="inline" border=0><img src="'.$image.'"></a>';
