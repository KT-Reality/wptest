...
<fieldset>
        <div class="pure-control-group">
            <label for="name"><?php _e('Youtube Title', 'upg'); ?></label>
		...
		?>
		  <div class="pure-control-group">
				 <label for="desp"><?php _e('Youtube Description', 'upg'); ?></label>
		...
		<div class="pure-control-group">
           ...
           <?php echo upg_droplist_category(); ?>
		     ...
		     <div class="pure-control-group">
            <label for="url"><?php _e('Youtube URL', 'upg'); ?></label>
            <input class="pure-input-1 pure-input-rounded" id="url" name="user-submitted-url" type="url" value="" placeholder="<?php _e('copy/paste Youtube URL', 'upg'); ?>" required>
<ul>
		...
		?>
		 ...
		 <div class="pure-controls">
			<button type="submit" name="SN" class="pure-button pure-button-primary"><?php esc_html_e( 'Submit URL', 'wp-upg' ); ?></button>
