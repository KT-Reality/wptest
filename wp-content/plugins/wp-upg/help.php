...
if (function_exists('exif_imagetype')) 
{
 ...
 {
    echo "<li>exif_imagetype is not available in your server. This is important to check file type uploded by user.</li>";
}
	flush_rewrite_rules();
	...
	echo "<li>Click <a href='http://odude.com/user-photo-gallery/' targe='_blank'>this link</a> for more basic installation questions and available features. </li>";
	echo "</ul>";
